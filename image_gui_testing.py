...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.maps_image = customtkinter.CTkImage(light_image=Image.open("Images/Maps.png"),
                                                 dark_image=Image.open("Images/Maps.png"), size=(100, 100))
        self.led_image = customtkinter.CTkImage(light_image=Image.open("Images/LED.png"),
                                                 dark_image=Image.open("Images/LED.png"), size=(100, 100))
        self.logs_image = customtkinter.CTkImage(light_image=Image.open("Images/Logs.png"),
                                                     dark_image=Image.open("Images/Logs.png"), size=(100, 100))
        self.volume_image = customtkinter.CTkImage(light_image=Image.open("Images/Volume.png"),
                                                     dark_image=Image.open("Images/Volume.png"), size=(75, 75))
        ...
        self.maps_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="",
                                                   fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                                   image=self.maps_image, command=self.maps_button_event)
        self.maps_button.grid(row=1, column=0, sticky="ew")

        self.led_frame_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="",
                                                      fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                                      image=self.led_image, command=self.led_frame_button_event)
        self.led_frame_button.grid(row=2, column=0, sticky="ew")

        self.logs_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="",
                                                      fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                                      image=self.logs_image, command=self.logs_button_event)
        ...
        map_widget = tkintermapview.TkinterMapView(self.home_frame, width=800, height=600, corner_radius=0)
        map_widget.place(relx=0.5, rely=0.5, anchor=tkinter.CENTER)
        map_widget.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=22)
        #"https://www.google.com/maps/@{x},{y},11z"
        ...
        # create logs frame
        self.logs_frame = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
    ...
    def select_frame_by_name(self, name):
        ...
        self.maps_button.configure(fg_color=("gray75", "gray25") if name == "maps" else "transparent")
